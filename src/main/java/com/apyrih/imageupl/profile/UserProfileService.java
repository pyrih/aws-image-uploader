...
import com.apyrih.imageupl.bucket.BucketName;
import com.apyrih.imageupl.filestore.FileStore;
...
public class UserProfileService {
    ...
    private void isImage(MultipartFile file) {
        if (!Arrays.asList(IMAGE_JPEG.getMimeType(),
            ...
            throw new IllegalStateException("File must be an image. Your file is " + file.getContentType());
        }
    }
